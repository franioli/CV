...
\begin{center}
    ...
    \small \textit{Autorizzo al trattamento dati ai sensi del GDPR 2016/679 del 27.04.2016 (Regolamento Europeo relativo alla protezione delle persone fisiche per quanta riguarda il trattamento dei dati personal).} \vspace{4pt}

    \small \textit{Autorizzo la pubblicazione del Curriculum Vitae sul sito istituzionale del Politecnico di Milano (sez. Amministrazione Trasparente) in ottemperanza al D. Lgs n. 33 del 14.03.2013 (es.m.i.)
    }
\end{center}
