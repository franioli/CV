...
\begin{paracol}{2}
    ...
    \begin{metasection}{Languages}
        \textcolor{white}{
            ...
            \icontext{GlobeAmericas}{10}{English}{white} C1
        }
    \end{metasection}
    ...
    \cvent[noline]{2021 -- 2024}{PhD Environmental and Infrastructure Engineering}{Dept. of Civil and Environmental Engineering, Politecnico di Milano}{Milan, Italy}{%
    ...
    \cvent[noline]{06/2025 -- present}{Post-doctoral Researcher R2}{CNR IRPI}{Turin, Italy}{%
...
\cvbullet{
    ...
    \textbf{Contributed to proposal writing} as work package leader.\newline
    MOHYCAM project aims for addressing hydrogeological vulnerabilities at the Belvedere Glacier (Monte Rosa), by  combining advanced glacier dynamics monitoring with community-based risk awareness strategies.
}
...
\vspace{4pt}
\textbf{Software, Datasets \& Infrastructure:}
...
\cventwide{2024 -- present}{PhD Student Mentoring}{University of Zurich \& CNR IRPI}{}{%
    ...
    Providing technical guidance on photogrammetric pipelines, satellite multi-view stereo, and glacier
    monitoring workflows.
}

\cventwide[noline]{2019 -- 2024}{MSc Thesis Co-supervisor}{Politecnico di Milano}{Milan, Italy}{%
    Co-supervised 6 Master's theses in Environmental and Land Planning Engineering (2020-2024):
    \begin{itemize}[nosep]
...
\cventwide{2020 -- 2024}{Teaching Assistant}{Politecnico di Milano}{Milan, Italy}{%
    ...
    \begin{itemize}[nosep]
        \item Photogrammetry and UAV surveying (MSc): Fall 2024
        \item \textit{Trattamento delle Osservazioni} (Statistics) (BSc): Fall 2020, 2021, 2022, 2023
        \item \textit{Sistemi Informativi Territoriali} (GIS) (BSc): Spring 2020, 2021
        \item \textit{Tecniche di rilievo e modellazione 3D per l'architettura} (3D Modelling for Architecture) (BSc): Spring 2020, 2021, 2022.
    \end{itemize}
}

\cventwide[noline]{2021 -- 2025}{Tutor in Summer Schools}{Politecnico di Milano}{Belvedere Glacier, Macugnaga, Italy}{%
    \textit{Design and Execution of Topographic Surveys for Land Monitoring} at the Belvedere Glacier aimed at introducing BSc and MSc students to topographic fieldwork in mountain environments. %
}
...
\cventwide[noline]{2023}{EGU Higher Education Teaching Grant 2023}{EGU}{}{%
