...
\begin{paracol}{2}
    ...
    % You can remove the 'tcolorbox' background if you prefer a clean white look,
    % or keep the colored box for the details below the photo.
    ...
    {\Large\textbf{Geomatics Researcher \& Photogrammetry Specialist}} \\[4pt]
    {\large PhD in Geoinformatics | CNR IRPI (Italy)} \\[4pt]
