...
\defbibenvironment{bibliography}{%
    \list{}{%
        \setlength{\leftmargin}{1.5em}% % indent for bullet
        \setlength{\itemsep}{3pt}% % small space between entries
        \setlength{\parsep}{0pt}}} {\endlist} {%
...
% Compact bullet for inline lists (good inside tabular/tabularx cells)
\newcommand{\minibull}{\textcolor{softcol}{\scriptsize\faAngleRight}\hspace{0.6em}} % [web:60]
